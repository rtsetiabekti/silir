...
public class ThirdViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        secondTime = true;
        rootView = inflater.inflate(R.layout.third_view_fragment, container, false);
        image1 = (MaterialIconView) rootView.findViewById(R.id.phone);
        image2 = (MaterialIconView) rootView.findViewById(R.id.cloud);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && secondTime) {
            ...
            YoYo.with(Techniques.FadeIn).playOn(description);
        }
    }
}
